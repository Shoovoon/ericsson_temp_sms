...
<link rel="stylesheet" href="{{ asset('ui/assets/plugins/bootstrap/css/bootstrap.min.css') }}" />

<!-- Plugins css -->
<link rel="stylesheet" href="{{ asset('ui/assets/plugins/summernote/dist/summernote.css') }}"/>


<!-- Core css -->
<link rel="stylesheet" href="{{ asset('ui/assets/css/style.min.css') }}"/>
</head>
...
<div id="main_content">
   ...
   <x-partials.header_top />
    ...
    <x-partials.left_sidebar />
    <!-- Start project content area -->
    <div class="page">
        <!-- Start Page header -->
        <x-partials.project_content />
        <!-- Start Page title and tab -->
        {{-- breadcrumb and activity tab --}}
...
<script src="ui/assets/bundles/lib.vendor.bundle.js"></script>

<!-- Start all plugin js -->
<script src="{{ asset('ui/assets/bundles/counterup.bundle.js') }}"></script>
<script src="{{ asset('ui/assets/bundles/apexcharts.bundle.js') }}"></script>
<script src="{{ asset('ui/assets/bundles/summernote.bundle.js') }}"></script>

<!-- Start project main js  and page js -->
<script src="{{ asset('ui/assets/js/core.js') }}"></script>
<script src= "{{ asset('ui/assets/js/page/index.js') }}"></script>
<script src= "{{ asset('ui/assets/js/page/summernote.js') }}"></script>
</body>
</html>
